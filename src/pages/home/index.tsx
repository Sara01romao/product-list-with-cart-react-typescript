          ...
          <div className="border flex gap-x-6 gap-y-8 flex-wrap items-center justify-center min-[1206px]:justify-start m-auto">
              ...
              <div>
                  <div className="relative">
                      ...
                      <button className="group px-6 h-12 absolute bottom-[-20px] right-0 left-0 w-52 m-auto bg-white border-2 border-rose-[#AD8A85] flex items-center justify-center gap-5 rounded-full text-[#260F08] hover:bg-[#C73B0F] hover:text-white transition ease-in-out duration-300  ">
        ...
        <div className=" border  lg:max-w-md   max-[1000px]:w-4/5   p-6 bg-white rounded-xl ">
           ...
           <div className="">
              ...
              <div>
                  ...
                  <div className="mt-6 flex items-center gap-2 justify-center bg-[#FCF8F6] py-4 rounded-lg">
